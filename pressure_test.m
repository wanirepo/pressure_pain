        ...
        for tr_i = trial_starts(run_i):trial_num(run_i) % trial starts
            ...
            if tr_i == 1
                while (1)
                    ...
                    Run_start_text = 'If the participant is ready for the run, please press Space.';
                    runtextW = Screen('DrawText',theWindow,Run_start_text,0,0);
                    Screen(theWindow,'FillRect',bgcolor, window_rect);
                    Screen('DrawText',theWindow,Run_start_text,W/2-runtextW/2,H/2-promptH/2-150,white);
...
%                 end
        ...
        while (1) 
            ...
            if run_i < run_num
                Run_text{1} = ['This is the end of the run ' num2str(run_i) '.'];
                Run_text{2} = 'If the participant is ready for the next run, please press Space.';
            else
                Run_text{1} = 'This is the end of the experiment.';
                Run_text{2} = 'To finish the experiment, please press Space.';
            end
            runtextW1 = Screen('DrawText',theWindow,Run_text{1},0,0);
            runtextW2 = Screen('DrawText',theWindow,Run_text{2},0,0);
            runtextW = max(runtextW1, runtextW2);
            Screen(theWindow,'FillRect',bgcolor, window_rect); 
            Screen('DrawText',theWindow,Run_text{1},W/2-runtextW/2,H/2-promptH/2-150,white); 
            Screen('DrawText',theWindow,Run_text{2},W/2-runtextW/2,H/2+promptH-150,white); 
            Screen('Flip', theWindow);
        end
...
prompt_ex{1} = 'Scale example: explain how to use the scale, and press Space.';
prompt_ex{2} = 'Scale example: practice rating, and when you are done, please click the mouse.';
prompt_ex{3} = 'Great job! If you are ready, please press Space.';
